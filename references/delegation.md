...
Load this protocol only inside a worker selected by the Isolation Gate. Also read exactly the one Decision, Exploration, Codebase Memory, Debugging, or Implementation module assigned by the root.
